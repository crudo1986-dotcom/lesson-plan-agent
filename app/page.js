...
function LandingPage({ onEnter }) {
  const features = [
    ...
    { Icon: IconLesson,  title: "בניית מערך שיעור",   desc: "מבנה שיעור מלא עם פתיחה, עיבוד ופעילויות, בהתאם לתוכנית משרד החינוך" },
  ...
  if (!started) return (
    <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:"16px" }}>
      <div style={{ background:WH, borderRadius:18, border:`1px solid ${G200}`,
        ...
        <img src="/LOGO%20TOMER.png" alt="לוגו" style={{ height:90, width:"auto", objectFit:"contain", marginBottom:20 }}/>

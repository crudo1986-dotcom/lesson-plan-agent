...
הערות למורה: חובה לכלול —
- כיצד לחלק לרמות וקריטריוני הערכה לכל רמה
- מה לעשות עם כרטיסי היציאה
- קבוצות גמישות: הסבר שהחלוקה לרמות אינה קבועה — יש לעדכן לפי ביצועים. סימנים לשינוי רמה: תלמיד מסיים מהר מדי (הרמה קלה מדי) או לא מתחיל לכתוב (הרמה קשה מדי).
- סביבת עבודה: המלצה קצרה על סידור הכיתה — לדוגמה: פינת עבודה שקטה לרמה א', עבודה בזוגות לרמה ב', עבודה עצמאית לרמה ג'.`;
